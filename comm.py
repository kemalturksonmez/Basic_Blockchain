...
class Communication():
        ...
        def display_received_msg(self):
                while True:
                        if self.raft_receive != None:
                                msg_list = self.receive_msg()
                                for msg in msg_list:
        ...
        def set_raft_receive(self, wb):
                self.raft_receive = wb
        ...
        def check_restart(self):
                self.restart = os.path.isfile(str(self.node_id) + '/state.json')
